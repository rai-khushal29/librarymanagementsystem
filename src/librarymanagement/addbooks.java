...
public class addbooks extends javax.swing.JFrame {
         ...
         public void getbid(){
          try{
           ...
           while(rs.next()){
            ...
            bookid.setText(String.valueOf(bid));
           }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/librarymanagement/addbook.png"))); // NOI18N
        ...
        jPanel1.setBounds(290, 40, 595, 330);
        ...
        jButton1.setBounds(680, 410, 90, 23);

        jButton2.setText("Clear");
        getContentPane().add(jButton2);
        jButton2.setBounds(800, 410, 70, 23);

        jPanel3.setOpaque(false);

        jLabel7.setIcon(new javax.swing.ImageIcon("D:\\documents\\NetBeansProjects\\LibraryManagement\\src\\librarymanagement\\add-book.png")); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String sql = "insert into books values(?, ?, ?, ?, ?,?)";
            ...
            pstmt.setString(4, pub.getText());
            pstmt.setInt(5, Integer.parseInt(edt.getText()));
